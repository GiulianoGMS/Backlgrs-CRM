CREATE OR REPLACE VIEW NAGV_BKLGRS_PRODUTO_V3 AS
SELECT X.SEQPRODUTO IDPRODUTO,
       ...
       NVL(NAGF_BUSCAEAN_BKLGRS_V2(X.SEQPRODUTO, 'E'), X.SEQPRODUTO) EAN,
       ...
       CASE WHEN F.PESAVEL = 'S' THEN NAGF_BUSCAEAN_BKLGRS_V2(X.SEQPRODUTO, 'B') ELSE NULL END COD_BAL
