...
SELECT /*+ INDEX(S MRLPRODSKY) */
       ...
       CASE WHEN C.CATEGORIAN1 = 'HORTIFRUTI' AND NOT EXISTS (SELECT 1 FROM MAP_PRODCODIGO E WHERE E.SEQPRODUTO = S.SEQPRODUTO AND E.TIPCODIGO = 'E') THEN 1
            WHEN C.CATEGORIAN1 IN ('AÇOUGUE', 'PADARIA', 'FRIOS E LATICINIOS')   AND EXISTS (SELECT 1 FROM NAGT_DEPARA_STOCK_IEAP DP WHERE DP.SEQPRODUTO = S.SEQPRODUTO) THEN 1
            ELSE 0 END PERPETUO
